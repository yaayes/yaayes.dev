...
tags: ["devops", "security", "ansible", "best-practices", "tutorial", "secrets-management", "hashicorp-vault", "github-secrets"]
draft: false
---
...
Use 1Password Teams, Bitwarden Organizations, or similar. Create a shared vault. Put the Ansible vault password there. Everyone on the team gets access. When someone leaves, you change the password, re-encrypt, and update the shared vault.
...
If you're already on AWS, Azure, or GCP, use their native secrets managers (AWS Secrets Manager, Azure Key Vault, GCP Secret Manager). More setup, but much better audit trails and access control.
